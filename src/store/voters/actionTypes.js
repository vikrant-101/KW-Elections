...
export const GET_CLASS_VOTERS = "GET_CLASS_VOTERS";
export const GET_CLASS_VOTERS_SUCCESS = "GET_CLASS_VOTERS_SUCCESS";
export const GET_CLASS_VOTERS_FAIL = "GET_CLASS_VOTERS_FAIL";

export const GET_ARABIC_ALPHABETS = "GET_ARABIC_ALPHABETS"
export const GET_ARABIC_ALPHABETS_SUCCESS = "GET_ARABIC_ALPHABETS"
export const GET_ARABIC_ALPHABETS_FAIL = "GET_ARABIC_ALPHABETS"
