...
import { getFamilyNameWiseReport, getFamilyNameWiseTableColumnNames } from "../../../store/analyticalReport/actions";
import { getPrintDetail } from "../../../store/voters/actions";
import { CSVLink } from 'react-csv'
import { Link } from "react-router-dom";
import yasaLight from '../../../assets/images/horizonatal-view.png'

const FamilyNameWiseReport = () => {
  const { t, i18n } = useTranslation();
  document.title = t('KW-Elections | Family Name Wise Report');
  ...
  const [data, setData] = useState(FamilyNameWise)

  useEffect(() => {
    setData(FamilyNameWise)
  }, [FamilyNameWise]);
  ...
  useEffect(() => {
    dispatch(getFamilyNameWiseReport({ userID: user.id }))
    dispatch(getFamilyNameWiseTableColumnNames())
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <Row className='mb-3'>
            <Col>
              <BreadCrumb title={t('Family Name Wise Report')} />
            </Col>
          </Row>
          <Row className='mb-3'>
            ...
            <Col className="col-12 col-md-3 col-lg-3">
              <label> &nbsp;</label> <br />
              <SearchTextBox initialData={FamilyNameWise} setData={setData} />
            </Col>
          </Row>
          <Row>
            <Col>
...
export default FamilyNameWiseReport;