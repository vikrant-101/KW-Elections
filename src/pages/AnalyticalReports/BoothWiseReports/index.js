...
const BoothWiseReports = () => {
  ...
  document.title = t('KW-Elections | Booth Wise Report');
  ...
  useEffect(() => {
    dispatch(getBoothWiseReport({ userID: user.id }))
  ...
  const printTable = (e, columns) => {
    ...
    newWindow.document.write(`<style>title { text-align: center; }</style><title>Booth Wise List</title>`);
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <Row className='mb-3'>
            <Col>
              <BreadCrumb title={t('Booth Wise Report')} />
            </Col>
          </Row>
          <Row className='mb-3'>
