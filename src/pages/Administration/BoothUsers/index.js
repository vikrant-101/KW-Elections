...
import { addBoothUsers, getBoothUsers, getBoothUsersTableColumnNames, updateBoothUsers } from "../../../store/boothusers/actions";
...
const BoothUsers = () => {
  ...
  return (
    <React.Fragment>
        ...
        <Container fluid>
          ...
          <Row className='mb-3'>
            <Col>
              ...
              { !data && <AddGenrateButton handleClassesClicks={getBoothUsersClicks} />}
            </Col>
            <Col>
      ...
      {/* <AddModal show={show} setShow={setShow} onSubmitHandler={onSubmitHandler} title={isAddOrEdit === 'isAdd' ? t('Add New Users') : t('Edit Users')} modalBody={<AddUsersForm onChangeHandler={onChangeHandler} labels={labels} show={show} classRow={classRow} isAddOrEdit={isAddOrEdit} />} /> */}
