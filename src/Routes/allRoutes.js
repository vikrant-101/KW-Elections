...
// Administration
import CreateElections from "../pages/Administration/CreateElections";
import Localization from "../pages/Administration/Localization";
import UploadVoters from "../pages/Administration/UploadVoters";
import CreateCandidates from "../pages/Administration/CreateCandidates";
import AddUsers from "../pages/Administration/AddUsers";
...
import RolesWiseSelectedVotersList from "../pages/DataReports/RolesWiseSelectedVoterList";
import BoothWiseReport from "../pages/DataReports/BoothWiseReport";
import DuplicateReferedReport from "../pages/DataReports/DuplicateReferedReport";
import AreaWiseReport from "../pages/AnalyticalReports/AreaWiseReport";
import SchoolWiseReport from "../pages/AnalyticalReports/SchoolWiseReport";
import BoothWiseReports from "../pages/AnalyticalReports/BoothWiseReports";
import FamilyNameWiseReport from "../pages/AnalyticalReports/FamilyNameWiseReport";
import ElectionDayReport from "../pages/ElectionDayReport";
import Dashboard from "../pages/Dashboard";
import CreateCircles from "../pages/Administration/CreateCircles";

const authProtectedRoutes = [
  // Administration
  { path: "/administration/create-elections", component: <CreateElections /> },
  { path: "/administration/create-circles", component: <CreateCircles /> },
  { path: "/administration/localization", component: <Localization /> },
  { path: "/administration/upload-voters", component: <UploadVoters /> },
  { path: "/administration/create-candidates", component: <CreateCandidates /> },
  { path: "/administration/add-users", component: <AddUsers /> },
  { path: "/administration/booth-users", component: <BoothUsers /> },
  ...
  // Data Reports
  { path: "/data-reports/all-voters-list", component: <AllVotersList /> },
  { path: "/data-reports/all-refered-voters-list", component: <AllReferedVotersList /> },
  { path: "/data-reports/roles-wise-selected-voters-list", component: <RolesWiseSelectedVotersList /> },
  { path: "/data-reports/booth-wise-report", component: <BoothWiseReport /> },
  { path: "/data-reports/duplicate-refered-report", component: <DuplicateReferedReport /> },

  //Analytical Reports
  { path: "/analytical-reports/area-wise-report", component: <AreaWiseReport /> },
  { path: "/analytical-reports/school-wise-report", component: <SchoolWiseReport /> },
  { path: "/analytical-reports/booth-wise-reports", component: <BoothWiseReports /> },
  { path: "/analytical-reports/family-name-wise-report", component: <FamilyNameWiseReport /> },

  //Election Day Reports
  { path: "/election-day-report", component: <ElectionDayReport /> },
